 ...
 */
define( 'WC_PAYL8R_VERSION', '1.6.1' );
define( 'WC_PAYL8R_MIN_PHP_VER', '7.4.0' );
...
if ( ! class_exists( 'WC_PayL8r' ) ) :
	...
	class WC_PayL8r {
		...
		protected function __construct() {
            ...
            add_action( 'woocommerce_blocks_loaded', [$this,'payl8r_gateway_block_support'] );
		...
		public function init() {
            ...
            add_action( 'before_woocommerce_init', [$this,'payl8r_cart_checkout_blocks_compatibility'] );
		}
        ...
        public function payl8r_gateway_block_support() {
            ...
            require_once __DIR__ . '/includes/class-wc-gateway-payl8r-blocks-support.php';

            // registering the PHP class we have just included
            add_action(
                'woocommerce_blocks_payment_method_type_registration',
                function( Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry ) {
                    $payment_method_registry->register( new WC_Gateway_Payl8r_Blocks_Support );
                }
            );
        ...
        /**
         * Method tells WC that the gateway is compatible with the blocks
         * @return void
         */
        public function payl8r_cart_checkout_blocks_compatibility() {
